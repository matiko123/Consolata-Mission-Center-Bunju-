          ...
          <div class="collapse navbar-collapse mynav " id="navbarNavDropdown">
            <ul class="navbar-nav mydropdown mymedia" >
             ...
             <li class="nav-item" data-bs-toggle="modal" data-bs-target="#login"  data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" id="#">
                <a class="nav-link myactive" href="#" id="roomsLink">
  ...
  <path d="M14.247 14.269c1.01 0 1.587-.857 1.587-2.025v-.21C15.834 10.43 14.64 9 12.52 9h-.035C10.42 9 9 10.36 9 12.432v.214C9 14.82 10.438 16 12.358 16h.044c.594 0 1.018-.074 1.237-.175v-.73c-.245.11-.673.18-1.18.18h-.044c-1.334 0-2.571-.788-2.571-2.655v-.157c0-1.657 1.058-2.724 2.64-2.724h.04c1.535 0 2.484 1.05 2.484 2.326v.118c0 .975-.324 1.39-.639 1.39-.232 0-.41-.148-.41-.42v-2.19h-.906v.569h-.03c-.084-.298-.368-.63-.954-.63-.778 0-1.259.555-1.259 1.4v.528c0 .892.49 1.434 1.26 1.434.471 0 .896-.227 1.014-.643h.043c.118.42.617.648 1.12.648m-2.453-1.588v-.227c0-.546.227-.791.573-.791.297 0 .572.192.572.708v.367c0 .573-.253.744-.564.744-.354 0-.581-.215-.581-.8Z"/>
     ...
     <div class="container border border-primary-subtle" style="background-color: white;border-radius: 10px;display: block;" id="hallControl" >
      <div class="container px-4 text-center" style="margin-top: 0.5cm;">
        <div class="row gx-5">
          <div class="col btn btn-primary" onclick="hallPending()" id="hallPendingButton">
           <div class="p-3">Pending Approval <sup><span class="badge text-bg-danger"><?php echo count($data1) ?></span></sup></div>
          </div>
          <div class="col btn btn-outline-success mygap" onclick="hallApprove()" id="hallApproveButton" >
            <div class="p-3">Approved Bookings<sup><span class="badge text-bg-danger"><?php echo count($data2) ?></span></sup></div>
           </div>
...
<form action="../../control/updaterooms.php" method="post">
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body" >
        <h1 class="modal-title fs-5" style="display:none">Room With AC</h1><hr>
        <h1 class="modal-title fs-5"  style="display:'.$approval.'"><label>Select Room :
        <select name="roomname" style="max-height:3cm; overflow-y:auto">';

        for($i=25;$i<49;$i++){
          echo'
          <option value="Falda '.$i.' ">Falda '.$i.' </option>
          ';
        };

        for($i=1;$i<24;$i++){
          echo'
          <option value="Leonella '.$i.'">Leonella '.$i.' </option>
          ';
        };

        for($i=1;$i<19;$i++){
          echo'
          <option value="Magis '.$i.'">Magis '.$i.' </option>
          ';
        };
   ...
   echo '     </select></h1>
      ...
      <input type="hidden" name="id" value='.$entry['id'].'>
        <button type="submit" class="btn btn-outline-primary" style="display:'.$approval.'">
...
<div style="display: none;max-height: 11cm;
    overflow-y: scroll;" id="hallApproveTable">
<table class="table table-hover" style="margin-top: 0.5cm;font-size: small!important;">
        <thead>
          <tr>
            <th scope="col">#</th>
    ...
    echo '
          <tr>
            ...
            <td>'.$entry['departure_date'].'</td>
            <td>
            <form action="../../control/cancelroom.php" method="post" id="disapprove" >
            <input type="hidden" name="id" value='.$entry['id'].'>
...
<!--footer ends-->
 ...
 <a href="#" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" id="myanchor" style="display: none;">nav simulator</a>
  <!--End of  Navigation bar simulator on mobile--> 
    ...
    <script>
     if(window.location.href.includes("rooms/?updated")){
            function doneclick(){
