...
<div class="container" style="margin-top: 3cm;">
  ...
  <path d="M5.793 1a1 1 0 0 1 1.414 0l.647.646a.5.5 0 1 1-.708.708L6.5 1.707 2 6.207V12.5a.5.5 0 0 0 .5.5.5.5 0 0 1 0 1A1.5 1.5 0 0 1 1 12.5V7.207l-.146.147a.5.5 0 0 1-.708-.708zm3 1a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708zm.707.707L5 7.207V13.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5V7.207z"/>
              ...
              <li class="nav-item" data-bs-toggle="modal" data-bs-target="#login"  data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" id="#">
                <a class="nav-link myactive" href="#" id="mealsLink">        
  ...
  <path d="M14.247 14.269c1.01 0 1.587-.857 1.587-2.025v-.21C15.834 10.43 14.64 9 12.52 9h-.035C10.42 9 9 10.36 9 12.432v.214C9 14.82 10.438 16 12.358 16h.044c.594 0 1.018-.074 1.237-.175v-.73c-.245.11-.673.18-1.18.18h-.044c-1.334 0-2.571-.788-2.571-2.655v-.157c0-1.657 1.058-2.724 2.64-2.724h.04c1.535 0 2.484 1.05 2.484 2.326v.118c0 .975-.324 1.39-.639 1.39-.232 0-.41-.148-.41-.42v-2.19h-.906v.569h-.03c-.084-.298-.368-.63-.954-.63-.778 0-1.259.555-1.259 1.4v.528c0 .892.49 1.434 1.26 1.434.471 0 .896-.227 1.014-.643h.043c.118.42.617.648 1.12.648m-2.453-1.588v-.227c0-.546.227-.791.573-.791.297 0 .572.192.572.708v.367c0 .573-.253.744-.564.744-.354 0-.581-.215-.581-.8Z"/>
     ...
     <!--Meals Admin Container-->
     <div class="container border border-primary-subtle" style="background-color: white;border-radius: 10px;display: block;" id="mealsControl" >
      <div class="container px-4 text-center" style="margin-top: 0.5cm;">
        <div class="row gx-5">
          <div class="col btn btn-primary" onclick="mealsPending()" id="mealsPendingButton">
           <div class="p-3">Pending Approval <sup><span class="badge text-bg-danger"><?php echo count($data5) ?></span></sup></div>
          </div>
          <div class="col btn btn-outline-success mygap" onclick="mealsApprove()" id="mealsApproveButton" >
            <div class="p-3">Approved Bookings<sup><span class="badge text-bg-danger"><?php echo count($data6) ?></span></sup></div>
           </div>
          <div class="col btn btn-outline-primary mygap" onclick="manage()" id="manageButton" style="display:none">
            <div class="p-3 ">Approved Bookings<sup><span class="badge text-bg-danger">1</span></sup></div>
          </div>
        </div>
      </div>

      <div style="display: block;max-height: 15cm;
    overflow-y: scroll;" id="mealsPendingTable">
 ...
 <div >
    ...
    echo '
          <tr >
            ...
            <td>'.number_format($entry['price']*$entry['quantity']).'<i> Tsh</i></td>
            <td>'.$entry['booking_date'].'</td>
            <td>
              <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#mealscreenshot'.$entry['id'].'" >
...
<div class="modal fade" id="mealscreenshot'.$entry['id'].'" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Upload from :'.$entry['phone_email'].'</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <img src="../'.$entry['image'].'" class="img-fluid" alt="No Image Uploaded"><br><br>
      <div class="modal-footer">
<form action="../../control/updatemeals.php" method="post" id="approve">
      <input type="hidden" name="id" value='.$entry['id'].'>
        <button type="submit" class="btn btn-outline-primary" data-bs-dismiss="modal" style="display:'.$approval.'">
...
<!--Meals Approve Table table starts-->
<div style="display: none;" id="mealsApproveTable">
<table class="table table-hover" style="margin-top: 0.5cm;font-size: small!important;">
        <thead>
          <tr>
            <th scope="col">#</th>
    ...
    echo '
          <tr>
            ...
            <td>'.$entry['booking_date'].'</td>
            <td>
            <form action="../../control/cancelmeal.php" method="post" id="disapprove" >
            <input type="hidden" name="id" value='.$entry['id'].'>
