...
<div class="container" style="margin-top: 3cm;">
  ...
  <path d="M5.793 1a1 1 0 0 1 1.414 0l.647.646a.5.5 0 1 1-.708.708L6.5 1.707 2 6.207V12.5a.5.5 0 0 0 .5.5.5.5 0 0 1 0 1A1.5 1.5 0 0 1 1 12.5V7.207l-.146.147a.5.5 0 0 1-.708-.708zm3 1a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708zm.707.707L5 7.207V13.5a.5.5 0 0 0 .5.5h8a.5.5 0 0 0 .5-.5V7.207z"/>
              ...
              <li class="nav-item" data-bs-toggle="modal" data-bs-target="#login"  data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" id="#" >
                <a class="nav-link myactive" href="#" id="hallsLink">
      ...
      <div class="container px-4 text-center" style="margin-top: 0.5cm;">
        <div class="row gx-5">
          <div class="col btn btn-primary" onclick="hallPending()" id="hallPendingButton">
           <div class="p-3">Pending Approval <sup><span class="badge text-bg-danger"><?php echo count($data3) ?></span></sup></div>
          </div>
          <div class="col btn btn-outline-success mygap" onclick="hallApprove()" id="hallApproveButton" >
            <div class="p-3">Approved Bookings<sup><span class="badge text-bg-danger"><?php echo count($data4) ?></span></sup></div>
           </div>
...
<div class="modal fade" id="viewscreenshot'.$entry['id'].'" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <form action="../../control/updatehalls.php" method="post">
